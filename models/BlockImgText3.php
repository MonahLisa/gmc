...
/**
 * This is the model class for table "block_img_text_3".
 *
 * @property int $id
 ...
 */
class BlockImgText3 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(PageHasBlock::class, ['img_text_3_block' => 'id']);
    }
}
