...
/**
 * BlockText21Search represents the model behind the search form of `app\models\BlockText21`.
 */
class BlockText21Search extends BlockText21
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['main_title', 'second_title_1', 'second_title_2', 'text1', 'text2', 'main_title_color', 'second_title_color', 'text_color'], 'safe'],
        ];
    }
