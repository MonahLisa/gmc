...
use app\models\BlockImgText2Search;
...
/**
 * BlockImgText2Controller implements the CRUD actions for BlockImgText2 model.
 */
class BlockImgText2Controller extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all BlockImgText2 models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new BlockImgText2Search();
    ...
    /**
     * Displays a single BlockImgText2 model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Creates a new BlockImgText2 model.
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post())) {
                ...
                $page_block->img_text_2_block = $model->id;
    ...
    /**
     * Deletes an existing BlockImgText2 model.
    ...
    /**
     * Finds the BlockImgText2 model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return BlockImgText2 the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = BlockImgText2::findOne(['id' => $id])) !== null) {
            return $model;
        }
