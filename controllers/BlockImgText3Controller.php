...
use app\models\BlockImgText3Search;
...
/**
 * BlockImgText3Controller implements the CRUD actions for BlockImgText3 model.
 */
class BlockImgText3Controller extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all BlockImgText3 models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new BlockImgText3Search();
    ...
    /**
     * Displays a single BlockImgText3 model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Creates a new BlockImgText3 model.
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post())) {
                ...
                $page_block->img_text_3_block = $model->id;
    ...
    /**
     * Updates an existing BlockImgText3 model.
     * If update is successful, the browser will be redirected to the 'view' page.
     * @param int $id ID
     * @return string|\yii\web\Response
     * @throws NotFoundHttpException if the model cannot be found
    ...
    /**
     * Deletes an existing BlockImgText3 model.
    ...
    /**
     * Finds the BlockImgText3 model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return BlockImgText3 the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = BlockImgText3::findOne(['id' => $id])) !== null) {
            return $model;
        }
