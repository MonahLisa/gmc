...
<div class="block-text32-form">
    ...
    <?= $form->field($model, 'second_title_3')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'second_title_4')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'second_title_5')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'second_title_6')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'text6')->widget(Widget::className(), [
        'settings' => [
            'lang' => 'ru',
            'minHeight' => 200,
            'plugins' => [
